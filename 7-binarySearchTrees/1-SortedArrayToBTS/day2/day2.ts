...
return {
    ...
    if(tree.type === "node"){
        ...
        if (value < tree.value) {
        //save the result of recursive call and create "new left" for tree
        // const newLeft = addElementToTree(tree.left, value);
           return {
            value: tree.value,
            type: tree.type,
            left: addElementToTree(tree.left, value),
            right: tree.right,
           }
          } else { 
            return {
            ...
            type: tree.type,
            left: tree.left,
            right: addElementToTree(tree.right, value),
           }
          }
    }
